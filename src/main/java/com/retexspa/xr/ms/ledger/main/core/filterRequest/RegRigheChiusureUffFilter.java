...
@Getter
@Setter
public class RegRigheChiusureUffFilter {
    private String id;
    ...
    public RegRigheChiusureUffFilter() {
    }

    public RegRigheChiusureUffFilter(@JsonProperty("id") String id,
    ...
    public static RegRigheChiusureUffFilter createFilterFromMap(Object obj) {
        LinkedHashMap<String, Object> map = (LinkedHashMap<String, Object>) obj;
        RegRigheChiusureUffFilter filter = new RegRigheChiusureUffFilter();
        if(map != null){
